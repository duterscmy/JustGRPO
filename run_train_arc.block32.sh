...
accelerate launch --num_processes 4 --main_process_ip localhost --config_file configs/fsdp.yaml train_arc.py \
  --resume_ckpt /lus/lfs1aip2/projects/public/u6er/mingyu/justGRPO/checkpoints_arc_num_generation8_test_length128_block32_t1.0_lr1e-6_0425_batch64/training-state-000030 \
  --run_dir $output_dir \
  --block_size $block \
  --grad_accum 16 \
  --lr $lr \
